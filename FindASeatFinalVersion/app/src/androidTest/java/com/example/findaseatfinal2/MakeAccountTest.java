...
public class MakeAccountTest extends ActivityInstrumentationTestCase2<MainActivity> {


    private Solo solo;

    public MakeAccountTest() {
    ...
    public void tester() throws Exception {
        ...
        solo.enterText(0, "user23@usc.edu");
        ...
        boolean errorMessageFound = solo.waitForText("Tester", 1, 5000);
