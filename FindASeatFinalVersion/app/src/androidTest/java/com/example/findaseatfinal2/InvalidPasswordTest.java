...
public class InvalidPasswordTest extends ActivityInstrumentationTestCase2<MainActivity> {
    private Solo solo;
    ...
    public void tester() throws Exception {
        ...
        boolean errorMessageFound = solo.waitForText("Invalid Password Input", 1, 5000);
